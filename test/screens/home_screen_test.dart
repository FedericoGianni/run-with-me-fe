...
void main() {
  ...
  testWidgets('[HOME SCREEN]', (WidgetTester tester) async {
    ...
    // TODO still not working cause we don't have mock weather api!
    //await tester.pump();
    //expect(find.byKey(const Key("welcome_not_logged")), findsOneWidget);
    ...
    // tester.state<HomeScreenState>(find.byType(HomeScreen)).setState(() {});
    // await tester.pump();
  });
}
